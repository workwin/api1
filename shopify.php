...
class ShopifyClient {
	...
	public function call($method, $path, $params=array())
	{
		...
		//Too many request handle code starts from here
		//if($this->shop_domain=='caligent.myshopify.com'  )
		//{			
			$call_left = $this->callsLeft();			
			if($call_left<=2)
			{
				sleep(4);					
				$response = $this->curlHttpApiRequest($method, $url, $query, $payload, $request_headers);
			...
			//echo "<pre>";
			//print_r($this->last_response_headers);
			//echo $this->last_response_headers['http_x_shopify_shop_api_call_limit'];
		//}
		//Too many request handle code end here
