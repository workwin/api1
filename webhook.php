<?php
 ...
 define('SHOPIFY_API_KEY','fc8d2927c07e9a6da385b6503120fbda');
    ...
    {
        echo "yes";
 $select_store_data = mysql_query("DELETE FROM `app_data_tbl` WHERE `shop_address` = '".$query_params['shop']."'");
  $select_store_data = mysql_query("DELETE FROM `videos` WHERE `shop_address` = '".$query_params['shop']."'");
   $select_store_data = mysql_query("DELETE FROM `gallery_settings` WHERE `shop_address` = '".$query_params['shop']."'");
